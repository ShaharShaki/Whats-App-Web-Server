...
namespace Liron_api.Controllers
{
    public class MessagesController : Controller
    {
        ...
        public MessagesController(Liron_apiContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Message != null ? 
                          ...
                          Problem("Entity set 'Liron_apiContext.Message'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Liron_apiContext.Message'  is null.");
            }
            var message = await _context.Message.FindAsync(id);
            if (message != null)
            {
